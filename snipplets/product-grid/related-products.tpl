{# Misma estructura/clases que la grilla de colecciones (category.tpl + product_grid.tpl) #}
<div id="related-products" class="category-grid-container" data-store="related-products">
    ...
    {% if related_products | length > 0 %}
        <div class="related-products-header">
            <h5 class="h4-xs">{{ "Recomendados" | translate }}</h5>
        </div>
