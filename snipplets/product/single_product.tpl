    ...
    <div class="item">
        ...
        <div style="display: flex; justify-content: space-between; font-size: 10px; align-items: baseline;">
            ...
            <div class="row m-none">
                <div class="item-price-container d-none p-none col-xs-12"  data-store="product-item-price-{{ product.id }}">
                            <div class="{% if related_product %} font-small-xs {% endif %}">Hasta 3 cuotas sin interés</div>
                </div>
            </div>
