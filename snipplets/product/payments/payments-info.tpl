    ...
    <div id="installment-cash-option-{{ method }}" class="box-container">
        ...
        {% if method in ['boleto_paghiper'] and discount > 0.0 %}
            ...
            <h4 class="m-bottom">
                ...
                <span class="js-installments-one-payment price-compare m-right-half">{{ product.price | money }}</span><strong class="js-price-with-discount h3 weight-strong text-primary" data-payment-discount="{{ discount }}">{{ price_with_boleto_discount | money }}</strong>
            </h4>
